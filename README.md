...
4. Add the path to the jar file `pravega-sensor-collector/build/libs/pravega-sensor-collector-0.2.18.jar` generated by build-installer.sh in PravegaSensorCollectorApp.xml.
