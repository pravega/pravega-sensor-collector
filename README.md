...
|-------------------------------------------------------------|:----------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| `CREATE_SCOPE`                                              |                                    Scope should be created                                     |                                                                                                                     `true`                                                                                                                      |
|                                                             |                                     Default value = false                                      |                                                                                                                     `false`                                                                                                                     |
| `ROUTING_KEY`                                               |                                      Pravega routing key                                       |                                                                                                                  `routingkey1`                                                                                                                  |
| `ENABLE_PRAVEGA`                                            |                                      Default value = true                                      |                                                                                                               `Boolean parameter`                                                                                                               |
| `pravega_client_auth_method`                                |                        Authentication type to connect to Pravega client                        |                                                                                                                    `Bearer`                                                                                                                     |
| `pravega_client_auth_loadDynamic`                           |                                      Default value = true                                      |                                                                                                                    `Boolean`                                                                                                                    |
| `KEYCLOAK_SERVICE_ACCOUNT_FILE`                             |                             Path for keycloak service account file                             |                                                                                        `/opt/Pravega-sensor-collector/PSC_Files/keycloak-project1.json`                                                                                         |
| `PRAVEGA_SENSOR_COLLECTOR_ACCEL2_CLASS`                     |                             Pravega sensor collector class package                             | Raw File: `io.pravega.sensor.collector.file.rawfile.RawFileIngestService` <br> CSV file: `io.pravega.sensor.collector.file.csvfile.CsvFileIngestService` <br> Parquet file: `io.pravega.sensor.collector.file.parquet.ParquetFileIngestService` |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_FILE_SPEC`                   |                    Directory path from where PSC reads the files to process                    |                                                                                                                   `file path`                                                                                                                   |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_FILE_EXTENSION`              | Types of file Example:-  <br> Raw File: parquet <br>  CSV file: csv <br> Parquet file: parquet |                                                                                                                   `file type`                                                                                                                   |                                                                                      |                                                             | 
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_DATABASE_FILE`               |     Directory path where database file gets created Example: /opt/database/databasefile.db     |                                                                                                              `database file path`                                                                                                               |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_PRAVEGA_CONTROLLER_URI`      |                       Pravega controller URI EX: Pravega Controller URI                        |                                                                                       `tls://pravega-controller.foggy-nelson.ns.sdp.hop.lab.emc.com:443`                                                                                        |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_SCOPE`                       |                            Scope name for Pravega sensor collector                             |                                                                                                                    `scope1`                                                                                                                     |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_STREAM`                      |                            Stream name for Pravega sensor collector                            |                                                                                                                    `stream1`                                                                                                                    |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_ROUTING_KE`                  |                            Routing key for Pravega Sensor collector                            |                                                                                                                  `routingkey1`                                                                                                                  |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_DELETE_COMPLETED_FILES`      |                 If true, PSC immediately delete the file soon after processing                 |                                                                                                                     `false`                                                                                                                     |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_TRANSACTION_TIMEOUT_MINUTES` |                    Timeout for each transaction. Default value is 2 minutes                    |                                                                                                                      `2.0`                                                                                                                      |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_CREATE_SCOPE`                |                   Create scope if not created already. Accept Boolean value.                   |                                                                                                                     `false`                                                                                                                     |
