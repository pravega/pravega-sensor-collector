...
| `KEYCLOAK_SERVICE_ACCOUNT_FILE`                             |                         Path for keycloak service account file                         |    `String path`     |
| `PRAVEGA_SENSOR_COLLECTOR_ACCEL2_CLASS`                     |                         Pravega sensor collector class package                         |     `classpath`      |
|                                                             |                                       Example:-                                        |                      |
...
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_FILE_EXTENSION`              |   Types of file Example:-  Raw File: parquet,  CSV file: csv, Parquet file: parquet    |     `file type`      |                                                                                      |                                                             | 
...
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_PRAVEGA_CONTROLLER_URI`      |                   Pravega controller URI EX: Pravega Controller URI                    |   `Controller URI`   |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_SCOPE`                       |                        Scope name for Pravega sensor collector                         |     `Scope name`     |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_STREAM`                      |                        Stream name for Pravega sensor collector                        |    `Stream name`     |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_ROUTING_KE`                  |                        Routing key for Pravega Sensor collector                        |    `routingkey1`     |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_DELETE_COMPLETED_FILES`      |             If true, PSC immiediatly delete the file soon after processing             |       `false`        |
| `PRAVEGA_SENSOR_COLLECTOR_RAW1_TRANSACTION_TIMEOUT_MINUTES` |                Timeout for each trasaction. Default value is 2 minutes                 |        `2.0`         |
