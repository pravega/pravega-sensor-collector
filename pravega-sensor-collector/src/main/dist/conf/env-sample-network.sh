...
export PRAVEGA_SENSOR_COLLECTOR_NET1_NETWORK_INTERFACE=ens160
...
export PRAVEGA_SENSOR_COLLECTOR_NET1_PERSISTENT_QUEUE_FILE=/opt/pravega-sensor-collector/network-ens160.db
