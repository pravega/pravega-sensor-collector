...
public class RawFileProcessorTests {

    private static final Logger log = LoggerFactory.getLogger(RawFileProcessorTests.class);
    ...
    public void getNewFilesTest() {
        ...
        final List<FileNameWithOffset> actual = RawFileProcessor.getNewFiles(directoryListing, completedFiles);
    ...
    public void getDirectoryListingTest() throws IOException {
        final List<FileNameWithOffset> actual = FileUtils.getDirectoryListing(
                "../parquet-file-sample-data/","parquet");
