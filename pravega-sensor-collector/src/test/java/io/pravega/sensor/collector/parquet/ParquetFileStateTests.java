...
public class ParquetFileStateTests {
    private static final Logger log = LoggerFactory.getLogger(ParquetFileStateTests.class);
    
    @Test
    public void pendingFilesTest() throws SQLException {
        final String stateDatabaseFileName = ":memory:";
        final ParquetFileState state = ParquetFileState.create(stateDatabaseFileName);
